# Adapted from the https://github.com/AIM-Harvard/pyradiomics
#!/usr/bin/env python
...
def main():
### Set your paths ##########################################################################################
  outdir = 'F:\Cathy\Research\STS\Code\RadiomicsCode\Features/'
  inputCSV = 'F:\Cathy\Research\STS\Code\RadiomicsCode\Data\\Image_Mask_list.csv'
  outputFilepath = os.path.join(outdir, 'testCases_volumes_binwidth5_Normalized.csv')
  progress_filename = os.path.join(outdir, 'testCases_volumes_binwidth5_Normalized.txt')
  params = 'F:\Cathy\Research\STS\Code\RadiomicsCode\Params_self_defined_rebuilt_clean_sumAvg_Normalized_binwidth_5.yaml'
#############################################################################################################
  ...
  for entry in flists:  # Loop over all columns (i.e. the test cases) # Loop over all images
